...
public class Blackjack {
    ...
    public static void main(String[] args) {
        ...
        String answer = "";
        while (true) {
            System.out.println("\n\nWould you like to hit or saty");
            answer = scan.nextLine();
            if (answer.equals("hit")) {
                nextPlayerCard = drawRandomCard();
                System.out.println("\nYou get a \n " + cardString(nextPlayerCard));
                playerTotal += Math.min(nextPlayerCard, 10);
        ...
        while (dealerTotal < 17) {
            nextDealerCard = drawRandomCard();
            System.out.println("\nDealer gets a\n" + cardString(nextDealerCard));
            dealerTotal += Math.min(nextDealerCard, 10);
            System.out.println("Dealer's totatl is " + dealerTotal);
            if (dealerTotal > 21) {
